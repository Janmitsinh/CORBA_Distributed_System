...
public class AppointmentDetailsModel {
    ...
    private String appointmentDate; // appointment date (e.x. 110224)
    ...
    public static String locateAppointmentServer(String appointmentID) {
        ...
        if ("MTL".equals(appointment)) {
            return MONTREAL_APPOINTMENT_SERVER;
        } else if ("QUE".equals(appointment)) {
    ...
    public static String locateAppointmentTimeSlot(String appointmentID) {
        ...
        if ("M".equals(timeSlot)) {
            return MORNING_SLOT;
        } else if ("A".equals(timeSlot)) {
